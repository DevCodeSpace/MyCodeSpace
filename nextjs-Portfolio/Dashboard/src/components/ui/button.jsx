...
// Note: Standard shadcn uses cva (class-variance-authority), but I'll write a simpler version
// to avoid extra dependency overhead if not strictly needed, or just standard classes.
// Actually, I promised "modern design". Let's just use standard tailwind classes mapped to props.
