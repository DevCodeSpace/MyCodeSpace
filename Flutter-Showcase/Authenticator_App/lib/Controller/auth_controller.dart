...
class AuthController extends GetxController {
  ...
  bool addAccount(AccountModel account) {
    ...
    final exists = accounts.any((e) {
      ...
      return existingSecret == normalizedSecret &&
          existingAccount == normalizedAccount;
    });
  ...
  String getOtp(String secret) {
    ...
    return OTP.generateTOTPCodeString(secret, DateTime.now().millisecondsSinceEpoch, interval: 30, length: 6, algorithm: Algorithm.SHA1, isGoogle: true);
  }
