    ...
    return [
      ...
      ConfigurationModel(
        ...
        trailingWidget: Switch(
          value: true,
          onChanged: (value) {},
          activeColor: StoreColors.darkBrown.withValues(alpha: 0.5),
          thumbColor: WidgetStateProperty.resolveWith<Color?>(
            (states) => Colors.white,
          ),
          activeTrackColor: StoreColors.darkBrown.withValues(alpha: 0.5),
          inactiveThumbColor: Colors.white,
          inactiveTrackColor: StoreColors.darkBrown.withValues(alpha: 0.5),
          trackOutlineWidth: WidgetStateProperty.resolveWith<double?>((_) => 0),
        ),
      ),
      ConfigurationModel(
        iconContainerColor: StoreColors.ligthPink,
