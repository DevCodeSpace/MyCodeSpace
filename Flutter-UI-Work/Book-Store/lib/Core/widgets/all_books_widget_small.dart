...
class AllBooksWidgetSmall extends StatelessWidget {
  const AllBooksWidgetSmall({super.key});
          ...
          Positioned(
            ...
            child: BookSideView(
              ...
              gradientColors: [
                ...
                BookStoreColors.lightPurple.withValues(alpha: 0.85),
                BookStoreColors.lightPurple.withValues(alpha: 0.85),
                BookStoreColors.lightPurple,
              ],
              showMiddleBar: true,
          ...
          Positioned(
            ...
            child: BookSideView(
              ...
              gradientColors: [
                ...
                BookStoreColors.lightGreen.withValues(alpha: 0.85),
                BookStoreColors.lightGreen.withValues(alpha: 0.85),
                BookStoreColors.darkGreen,
              ],
            ),
...
class BookBottomView extends StatelessWidget {
  ...
  const BookBottomView({required this.borderColor, super.key});
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: [Colors.grey[350]!, BookStoreColors.pagesColor],
                    stops: [0.15, 1],
                  ),
