...
import 'package:banking_app/Core/widgets/border_gradient.dart';
import 'package:banking_app/Core/widgets/client_profile_widget.dart';
import 'package:dart_extensions_pro/dart_extensions_pro.dart';
import 'package:flutter/material.dart';

class ClientsCountWidget extends StatelessWidget {
  const ClientsCountWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: BankingColors.darkGreen),
        child: Stack(
          children: [
            Positioned(
              top: -50,
