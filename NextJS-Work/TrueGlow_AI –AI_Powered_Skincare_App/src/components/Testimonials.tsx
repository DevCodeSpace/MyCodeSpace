const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    quote:
      "The PDF summary feature is underrated. I downloaded my appointment details and shared it with my family immediately. Everything was there  doctor, hospital, time, fees. Zero back-and-forth.",
    ...
    <section id="testimonials" className="bg-white py-16 lg:py-24 overflow-hidden">
      <div className="max-w-screen-2xl mx-auto px-6">
        ...
        <div className="text-center mb-10 lg:mb-16">
          ...
          <h2 className="text-[26px] sm:text-[32px] lg:text-[48px] font-extrabold text-[#0D1B4B] tracking-[-1px] leading-[1.1]">
